...
export const Level1 = meta.story({
  args: {
    day: { date: new Date('2026-02-02'), score: 15, level: 1 },
  },
});

export const Level2 = meta.story({
  args: {
    day: { date: new Date('2026-02-03'), score: 35, level: 2 },
  },
});

export const Level3 = meta.story({
  args: {
    day: { date: new Date('2026-02-04'), score: 60, level: 3 },
  },
});

export const Level4 = meta.story({
  args: {
    day: { date: new Date('2026-02-05'), score: 85, level: 4 },
  },
});
